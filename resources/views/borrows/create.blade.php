...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Peminjaman Buku Baru</h2>
        <p class="text-gray-600">Isi form untuk mencatat peminjaman buku</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('borrows.store') }}" method="POST">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('borrows.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-md">
                    Batal
                </a>
