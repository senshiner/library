        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-6 flex justify-between items-center">
                    <div>
                        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Detail Anggota</h2>
                        <p class="text-gray-600 mt-2">Informasi lengkap tentang anggota</p>
                    </div>
                ...
                <div class="bg-white border border-black rounded-lg 
                    ...
                    <div class="md:flex">
                        ...
                        <div class="md:w-2/3 p-6">
                            <h3 class="text-2xl font-bold text-gray-900 mb-4">{{ $member->name }}</h3>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg text-gray-900">{{ $member->join_date->format('d M Y') }}</p>
                                </div>
