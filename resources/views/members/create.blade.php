    ...
    <div class="py-6 sm:py-12 bg-cyan-50 dark:bg-slate-900 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <!-- Title -->
                <div class="mb-6">
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">Tambah Anggota Baru</h2>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Isi form berikut untuk menambah anggota baru</p>
                </div>
                     ...
                     value="{{ old('phone') }}">
                            ...
                            <div>
                                ...
                                <textarea name="address" id="address" rows="3"
                                    class="block w-full border border-black rounded-md shadow-[2px_2px_0px_rgba(0,0,0,1)]
                                           py-2 px-3 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500
                                           bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 dark:border-white/10">{{ old('address') }}</textarea>
                                @error('address')
                                    <p class="mt-1 text-sm text-red-600 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
