...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-600">Isi form berikut untuk menambah anggota baru</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('members.store') }}" method="POST">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('members.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-md">
                    Batal
                </a>
