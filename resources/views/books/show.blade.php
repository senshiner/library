            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white border border-black rounded-lg 
                    ...
                    <div class="md:flex">
                        ...
                        <div class="md:w-1/3 bg-gray-100 border-r border-black flex items-center justify-center p-8">
                            <div class="text-center">
                                ...
                                <p class="text-gray-600">Cover Buku</p>
                            </div>
                        </div>
                        ...
                        <div class="md:w-2/3 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-600 mb-1">Stok Total</label>
                                    <p class="text-lg text-gray-900">{{ $book->quantity }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-600 mb-1">Tersedia</label>
                            ...
                            <div class="mb-6">
                                ...
                                <p class="text-gray-700 bg-gray-50 border border-gray-300 p-4 rounded-md">{{ $book->description }}</p>
                            </div>
                            @endif
                                ...
                                <div class="flex gap-2">
                                    <form action="{{ route('books.destroy', $book) }}" method="POST" class="inline">
                                        ...
                                        <button type="submit" 
                                                ...
                                                class="bg-red-300 hover:bg-red-400 border border-black text-gray-900
                                                       shadow-[2px_2px_0px_rgba(0,0,0,1)]
                                                       active:translate-x-[1px] active:translate-y-[1px] active:shadow-none
                                                       transition-all px-4 py-2 rounded-md font-medium">
                                            🗑️ Hapus
