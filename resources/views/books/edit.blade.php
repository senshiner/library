    ...
    <div class="py-6 sm:py-12 bg-cyan-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <!-- Title -->
                <div class="mb-6">
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit Buku</h2>
                    <p class="text-gray-600 mt-2">Update informasi buku</p>
                </div>
                ...
                <div class="bg-white border border-black rounded-lg 
                    ...
                    <form action="{{ route('books.update', $book) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Available -->
                            <div>
                                <label for="available" class="block text-sm font-medium text-gray-900 mb-2">Tersedia *</label>
                                ...
                                @error('available')
                                    <p class="mt-1 text-sm text-red-600 font-medium">{{ $message }}</p>
                                @enderror
                                <p class="mt-1 text-xs text-gray-600">Maksimal: {{ $book->quantity }}</p>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="block w-full border border-black rounded-md shadow-[2px_2px_0px_rgba(0,0,0,1)]
                                           py-2 px-3 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500
                                           bg-white text-gray-900">{{ old('description', $book->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
